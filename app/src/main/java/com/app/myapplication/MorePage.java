...
public class MorePage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		getMenuInflater().inflate(R.menu.more_page, menu);
		return true;
	}
	...
	public boolean onNavigationItemSelected(MenuItem item)
	{
		...
		{
			startActivity(new Intent(MorePage.this, IndexActivity.class));
		}
		else if(id == R.id.nav_gallery)
		{
			startActivity(new Intent(MorePage.this, UploadPage.class));
		}
		else if(id == R.id.nav_slideshow)
		{
			startActivity(new Intent(MorePage.this, CartPage.class));
		}
